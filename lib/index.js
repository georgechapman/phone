...
var iso3166_data = [
	...
	// http://countrycode.org/usa
	{
		...
		mobile_begin_with: ["201", "202", "203", "205", "206", "207", "208", "209", "210", "212", "213", "214", "215",
			...
			"854", "856", "857", "858", "859", "860", "862", "863", "864", "865", "870", "872", "878", "901", "903",
...
module.exports = function (phone, country) {
	...
	if (country) {
		// remove leading 0s for all countries except 'GAB', 'GBR', 'CIV', 'COG'
		if (['GAB', 'GBR', 'CIV', 'COG'].indexOf(iso3166.alpha3) === -1) {
	...
	if (validate_phone_iso3166(phone, iso3166)) {
		return ['+' + phone, iso3166.alpha3, iso3166.country_code];
	}
	return result;
};
